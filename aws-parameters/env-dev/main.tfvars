parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devopsb71services.site:8080/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devopsb71services.site:8080/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopsb71services.site:8080/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopsb71services.site:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopsb71services.site:8080/", type = "String" },
  ...
  { name = "dev.payment.user_host", value = "user-dev.devopsb71services.site", type = "String" },
  { name = "dev.payment.user_port", value = "8080", type = "String" },

  { name = "dev.payment.amqp_host", value = "rabbitmq-dev.devopsb71services.site", type = "String" },

  { name = "dev.catalogue.mongo", value = "true", type = "String" },
  { name = "dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.devopsb71services.site:27017/catalogue", type = "String" },
...
secrets = [
  ...
  { name = "dev.docdb.amqp_user", value = "admin1", type = "SecureString" }
  { name = "dev.docdb.amqp_pass", value = "RoboShop1", type = "SecureString" }
]
